...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
-> use a real example: questionnaire data from personality test, with various repetitions and maybe conditions.
here the tidy format could use standard code to process the data while the tidy format would require more custom code.
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
We refer to the entity that is interacting with the questionnaire as an "agent" and encode that information in the main table as follows: 
 ...
 Note that agent_id serves as a key to access more information about that agent (e.g., within an Agent table) such as age, gender, education, and possibly an id that may be used to link that agents' data across multiple datasests (e.g., when a person was involved in multiple studies) or even link to personal data, such as email addreses, as may be necessary for the logistics of running studies and paying participants.
