...
![Selecting the data referring to a question of interest is harder under the wide than under the long data format.](figures/fig_2.png){#fig-2}
...
![Metadata are more concise and easier to manage under the long, tidy format than under the wide data format.](figures/fig_4.png){#fig-4}
